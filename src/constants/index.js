...
const performanceImgPositions = [
    {
        ...
        left: 5,
        bottom: 65,
        tablet: { left: 15, bottom: 70 },
        mobile: { left: 45, bottom: 65 },
    },
    {
        id: "p2",
        right: 10,
        bottom: 60,
        tablet: { right: 15, bottom: 65 },
        mobile: { right: 25, bottom: 70 },
    },
    {
        id: "p3",
        right: -5,
        bottom: 45,
        tablet: { right: 10, bottom: 45 },
        mobile: { right: 20, bottom: 50 },
    },
    {
        id: "p4",
        right: -10,
        bottom: 0,
        tablet: { right: 5, bottom: 5 },
        mobile: { right: 15, bottom: 10 },
    },
    {
        id: "p5",
        left: 20,
        bottom: 50,
        tablet: { left: 25, bottom: 50 },
        mobile: { left: 35, bottom: 55 },
    },
    {
        id: "p6",
        left: 2,
        bottom: 30,
        tablet: { left: 10, bottom: 35 },
        mobile: { left: 20, bottom: 40 },
    },
    {
        id: "p7",
        left: -5,
        bottom: 0,
        tablet: { left: 5, bottom: 10 },
        mobile: { left: 15, bottom: 15 },
    },
];
